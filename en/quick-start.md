...
Download the installer from [www.skribane.com](https://www.skribane.com) and run it. The wizard will guide you step by step. Skribane installs on your computer like any other application — your data is stored locally, never in the cloud.

::: tip Windows SmartScreen Note
...
- **Google Gemini** (Gemini 2.5 Flash, Gemini 2.5 Pro) — [Get API key](https://aistudio.google.com/apikey)
- **Anthropic Claude** (Sonnet 4, Haiku 4.5) — [Get API key](https://console.anthropic.com/settings/keys)

To set it up:

1. Click **Config** in the left sidebar (bottom).
2. Enter your API key for your preferred provider.
3. Select the model you want to use by default.

::: info How Much Does the AI Cost?
...
::: tip Free Local AI
If you prefer not to pay for AI, you can use free local models with [LM Studio](https://lmstudio.ai/) or [Ollama](https://ollama.com/). In Skribane's settings, enable "Local AI" and enter your server URL (remember to add `/v1` at the end, e.g., `http://localhost:1234/v1`).
:::
...
- [Interface and Navigation](/en/interface) — Learn all panels and shortcuts.
